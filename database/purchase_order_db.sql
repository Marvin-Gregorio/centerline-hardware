...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 04, 2023 at 12:02 AM
...
(1, '02', 'Pozzoland Cement', 1, '2021-09-08 10:17:19'),
(2, 'Item 102', 'Sample Only', 1, '2021-09-08 10:21:42'),
(3, 'Item 3', 'Sample product 103. 3x25 per boxes', 1, '2021-09-08 10:22:10'),
(4, '01', 'Portlan Cenment', 1, '2023-12-03 21:51:41'),
(5, '03', 'Skim Coat', 1, '2023-12-03 21:54:36'),
(6, '04', 'Tile Adhesive\r\n', 1, '2023-12-03 21:57:16'),
(7, '02', 'Pozzoland Cement', 1, '2021-09-08 10:17:19');
-- --------------------------------------------------------
...
CREATE TABLE `po_list` (
  ...
  `notes` text NOT NULL,
  `status` tinyint(1) NOT NULL DEFAULT 0 COMMENT '5=pending, 1= Approved, 2 = Denied',
  `date_created` datetime NOT NULL DEFAULT current_timestamp(),
...
(3, 'PO-06223845006', 1, 0, 0, 0, 0, '', 0, '2023-12-03 21:36:44', NULL),
(4, 'PO-79988227043', 1, 0, 0, 0, 0, '', 0, '2023-12-03 21:58:47', NULL),
(5, 'PO-86854596846', 1, 0, 0, 0, 0, '', 0, '2023-12-03 21:58:59', NULL);
...
(1, 'name', ' Centerline Hardware and Construction Materials'),
(6, 'short_name', 'OPIS CHCM'),
(11, 'logo', 'uploads/1701605280_1701427980_logo.jpg'),
(13, 'user_avatar', 'uploads/user_avatar.jpg'),
(14, 'cover', 'uploads/1701605280_1701427980_bg.jpg'),
(15, 'company_name', 'CENTERLINE'),
(16, 'company_email', 'centerlinehardware.iriga@gmail.com'),
(17, 'company_address', '509 Elias Corporal Street, San Agustin Iriga City');
...
(1, 'Vianne', 'Valencia', 'admin', '0192023a7bbd73250516f069df18b500', 'uploads/1701604800_admin-login-icon-15.jpg', NULL, 1, '2021-01-20 14:02:37', '2023-12-03 20:00:57'),
