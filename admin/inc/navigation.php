...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-dark-primary bg-black elevation-4 sidebar-no-expand">
        ...
        <img src="<?php echo validate_image($_settings->info('logo'))?>" alt="Store Logo" class="brand-image img-circle elevation-4" style="height: 100px;">
        <span class="brand-text font-weight-black"><?php echo $_settings->info('short_name') ?></span>
        </a>
        <!-- Sidebar -->
